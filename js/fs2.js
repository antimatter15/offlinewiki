...
//                 "/ip4/127.0.0.1/tcp/9999/ws/ipfs/QmVicH2JmrjkVNyCHSFMpKA3eGwUom4XZXu5o7CRDxdGqr",
//                 '/dns4/wrtc-star.discovery.libp2p.io/tcp/443/wss/p2p-webrtc-star',
//                 "/ip4/127.0.0.1/tcp/4001/ipfs/QmVicH2JmrjkVNyCHSFMpKA3eGwUom4XZXu5o7CRDxdGqr",
//     "/ip4/192.168.1.244/tcp/4001/ipfs/QmVicH2JmrjkVNyCHSFMpKA3eGwUom4XZXu5o7CRDxdGqr",
...
function VirtualFile(name, size, chunksize, network){
  ...
  }else if(rfs && navigator.webkitPersistentStorage){
    persistent = 1;

    navigator.webkitPersistentStorage.requestQuota(defaultsize, 
...
for(var dump_id in dumps){
  var opt = new Option(dumps[dump_id].name, dump_id)
  document.getElementById('dump').appendChild(opt)
}
