...
<img width="1330" height="1082" alt="image" src="https://github.com/user-attachments/assets/b2f32879-b008-41f5-b64b-98665d4a08bb" />

In middle school, I had an iPhone— but it didn't actually have cell service, which led to more than a few expeditions for the fabled WiFi. My favorite app was [Patrick Collison's Encyclopedia](https://web.archive.org/web/20080913191907/http://collison.ie/wikipedia-iphone/), which contained the full compressed contents of the English Wikipedia. It left a powerful impression on me— I felt the true power of a real-life Hitchhiker's Guide.

In 2011, I realized that the web platform now had the features necessary to implement it in a browser, which I thought was cool. Also, there was like some competition for getting the first Google Chromebook, a CR-48 and I submitted it as a project idea in order to get a free laptop. 
